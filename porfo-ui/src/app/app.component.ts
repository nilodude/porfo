...
const sketch = (p: p5) => {
  ...
  p.draw = () => {
    ...
    p.fill(Math.random()*220,50+Math.random()*220,50+Math.random()*220,Math.random()*40)
    p.stroke(Math.random()*100,Math.random()*100,Math.random()*100,Math.random()*30)
    ...
    p.curve(x, y+Math.random()*500 ,x+w ,y+Math.random()*500,x, y+Math.random()*700 ,x+Math.random()*500*y/20 ,y+h+Math.random()*500)
  };
};
